% This is a simple example showing how to fit an ellipse with arbitrary 
% orientation to data using active geometric shape model. 
...
%% 4. ellipse fitting
[xc, yc, r] = InitialCircle(I2); % initial guess
init=[xc,yc,r,r,0]; % initial parameters
...
t=toc;
fprintf('Running 2-stage AGSM for ellipse fitting takes %f seconds \n',t);
